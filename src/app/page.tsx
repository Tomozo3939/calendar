    ...
    <div className="max-w-lg mx-auto min-h-dvh flex flex-col">
      ...
      <nav className="sticky bottom-0 bg-white/90 backdrop-blur-md border-t border-gray-100 px-6 py-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]" aria-label="メインナビゲーション">
        <div className="flex justify-around">
          <button aria-label="カレンダー" className="flex flex-col items-center gap-0.5 text-blue-600 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none rounded-lg p-1">
          ...
          <button aria-label="送迎一覧" className="flex flex-col items-center gap-0.5 text-gray-400 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none rounded-lg p-1">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
          ...
          <button aria-label="設定" className="flex flex-col items-center gap-0.5 text-gray-400 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none rounded-lg p-1">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
